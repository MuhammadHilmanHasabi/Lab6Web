...
Kode PHP Dasar:
Buat file php_dasar.php di dalam folder lab7_php_dasar. Salin kode berikut untuk menampilkan teks "Hello World": php
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
...
Membuat program PHP sederhana dengan menggunakan form input yang menampilkan nama, tanggal lahir dan pekerjaan. Kemudian tampilkan outputnya dengan menghitung umur berdasarkan inputan tanggal lahir. Dan pilihan pekerjaan dengan gaji yang berbeda-beda sesuai pilihan pekerjaan.
...
Simpan kode di atas sebagai form_umur.php di dalam folder lab7_php_dasar. Akses melalui URL http://localhost/lab7_php_dasar/form_umur.php. Isi form dan tekan Kirim untuk melihat hasil output.
